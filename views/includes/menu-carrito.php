        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand me-lg-5 me-0" href="<?php echo RUTA; ?>">
                    <img src="<?php echo RUTA . 'assets/'; ?>images/shop.png" class="logo-image img-fluid" alt="templatemo pod talk">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="plantilla.php?pagina=login">Acceder</a>
                        </li>
                    </ul>
